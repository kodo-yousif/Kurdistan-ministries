...
$res = $k->query("select name , id from minister limit $number,20;");
$number++;



$num_all = $k->query("select count(*) as 'all' from minister;");
            ...
            <div class="pt-2 pb-2">
                <div class="card ml-2 mr-2 " style="box-shadow: 1px 1px 3px rgb(110, 110, 110) ;">
                    <div class="card-body text-center">
                        <h5 class="card-title mb-4">Ministers</h5>
                            ...
                            <tbody id="table_body">
                                <?php while ($fetch = $res->fetch_assoc()) { ?>
                                    <tr id="rowId-<?php echo $fetch['id']; ?>">
                                        ...
                                        <td><button onclick="window.location.href = 'ministerId.php?id=<?php echo $fetch['id']; ?>';" class="btn btn-primary btn-sm">Detail</button></td>
