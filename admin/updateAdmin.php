...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['updatePass']) && $_POST['updatePass'] == "yes") {
    if (
        ...
        $k->query("update president set password = '$password' where id = '$id';");
        $updated = TRUE;
    }
}
...
if (isset($_REQUEST['id']) && strlen($_REQUEST['id']) != 0) {
    ...
    $res = $k->query("select id ,name , created_at , email from president where id = $currentId");
...
<body class="sidebar-mini sidebar-closed sidebar-collapse">
        ...
        <div class="content-wrapper cf" id="main_content">
            <div class="p-2">
                ...
                <div class="card mb-5 ml-auto mr-auto " style="max-width: 500px; box-shadow: 2px 2px 7px rgb(95, 95, 95) ;">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Update Admin: <?php echo $name; ?></h5>
    ...
    <script>
        ...
        $(() => {
            ...
            <?php if ($updated) { ?>
                setTimeout(() => {
                    err_m("admin updated successfully.")
                }, 1000);
            <?php } ?>
