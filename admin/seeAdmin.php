...
$res = $k->query("select name , id from president limit $number,20;");
$number++;



$num_all = $k->query("select count(*) as 'all' from president;");
                            ...
                            <tbody id="table_body">
                                ...
                                <?php while ($fetch = $res->fetch_assoc()) { ?>
                                    <tr id="rowId-<?php echo $fetch['id']; ?>">
                                        ...
                                        <td><button onclick="window.location.href = 'updateAdmin.php?id=<?php echo $fetch['id']; ?>';" class="btn btn-primary btn-sm">Detail</button></td>
