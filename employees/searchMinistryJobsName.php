...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['name'])) {
    ...
    $res = $k->query("select name , id from jobs where name like '%$name%' and ministry_id = '$ministry' limit 10;");
    ...
    while ($oneRow = $res->fetch_assoc()) {
        ...
        <td><button onclick=\"jobSelect($id)\" class=\"btn btn-primary btn-sm\">Select</button></td>
    </tr>";
        $counter++;
    }
