...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['name'])) {
    ...
    $res = $k->query("select name , id from building where name like '%$name%' and ministry_id = '$ministry' limit 10;");
    $counter = 1;
    $html = "";
    while ($oneRow = $res->fetch_assoc()) {
        ...
        <td><button onclick=\"buildingSelect($id)\" class=\"btn btn-primary btn-sm\">Select</button></td>
    </tr>";
        $counter++;
    }
